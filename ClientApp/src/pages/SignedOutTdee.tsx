...
const SignedOutTdee = () => {
  ...
  const [age, setAge] = useState(0) //48)
  const [sex, setSex] = useState('U') //'M')
  const [height, setHeight] = useState(0) //72) //0)
  const [weight, setWeight] = useState(0) // 186) //0)
  const [activityLevel, setActivityLevel] = useState(1.2)
  const [activityLevelLabel, setActivityLevelLabel] = useState('None') //'Sedentary')
